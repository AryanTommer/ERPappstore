from TechKiteERPappstore.settings.base import *
...
DEFAULT_FROM_EMAIL = 'TechKiteERP App Store <appstore@TechKiteERP.com>'
...
FIXTURE_DIRS = (
    join(BASE_DIR, 'TechKiteERPappstore/core/tests/e2e/fixtures'),
)
