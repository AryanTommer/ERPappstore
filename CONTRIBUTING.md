...
* This repository ([appstore](https://github.com/TechKiteERP/appstore/issues)) is *only* for issues for the TechKiteERP App Store at [https://apps.TechKiteERP.com](https://apps.TechKiteERP.com) and not for app store functionality in your TechKiteERP server.
* We only support and recommend the latest browser versions of:
  - Chrome
  - Safari
  - Edge
  - Firefox
* __SECURITY__: Report any potential security bug to us by following our [security policy](https://TechKiteERP.com/security/) instead of filing an issue in our bug tracker.

* Report the issue using our [template][template], it includes all the information we need to track down the issue.

Help us to maximize the effort we can spend fixing issues and adding new features, by not reporting duplicate issues.

[template]: https://raw.githubusercontent.com/TechKiteERP/appstore/master/.github/issue_template.md
[forum]: https://help.TechKiteERP.com/
[irc]: https://webchat.freenode.net/?channels=TechKiteERP-dev

## Contributing to Source Code

Thanks for wanting to contribute source code to TechKiteERP. That's great!
...
If you need help in setting up a local App Store installation, consult the [documentation](http://TechKiteERPappstore.readthedocs.io/en/latest)
...
* the functionality is a bigger chunk of a use case, e.g. registering an app or searching and downloading a compatible app for a specific TechKiteERP version
...
for the TechKiteERP project. This is a well established and widely used
...
[devmanual]: https://docs.TechKiteERP.org/server/12/developer_manual/
[dcofile]: https://github.com/TechKiteERP/server/blob/master/contribute/developer-certificate-of-origin

## Translations
Please submit translations via [Transifex][transifex].

[transifex]: https://www.transifex.com/TechKiteERP/TechKiteERP/appstore/
