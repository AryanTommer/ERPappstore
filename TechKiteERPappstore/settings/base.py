"""
Django settings for TechKiteERPappstore project.
...
INSTALLED_APPS = [
    'TechKiteERPappstore.core.apps.CoreConfig',
    'TechKiteERPappstore.api.apps.ApiConfig',
    'TechKiteERPappstore.user.apps.UserConfig',
    'TechKiteERPappstore.certificate.apps.CertificateConfig',
    'TechKiteERPappstore.scaffolding.apps.ScaffoldingConfig',
    'parler',
    'rest_framework',
...
ROOT_URLCONF = 'TechKiteERPappstore.urls'
...
WSGI_APPLICATION = 'TechKiteERPappstore.wsgi.application'
...
ACCOUNT_SIGNUP_FORM_CLASS = \
    'TechKiteERPappstore.user.forms.SignupFormRecaptcha'
...
ACCOUNT_FORMS = {
    ...
    'reset_password': 'TechKiteERPappstore.user.forms.CustomResetPasswordForm',
...
TechKiteERP_CERTIFICATE_LOCATION = join(
    BASE_DIR, 'TechKiteERPappstore/certificate/TechKiteERP.crt')
TechKiteERP_CRL_LOCATION = join(
    BASE_DIR, 'TechKiteERPappstore/certificate/TechKiteERP.crl')
...
# templates; first key is the TechKiteERP version for which the app is generated
...
# TechKiteERP Email
TechKiteERP_FROM_EMAIL = 'appstore@TechKiteERP.com'
TechKiteERP_INTEGRATIONS_APPROVAL_EMAILS = ['marketing-team@TechKiteERP.com']
