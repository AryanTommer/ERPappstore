...
from TechKiteERPappstore.core.caching import app_rating_etag
from TechKiteERPappstore.core.feeds import AppReleaseAtomFeed, AppReleaseRssFeed
from TechKiteERPappstore.core.views import CategoryAppListView, AppDetailView, \
    app_description, AppReleasesView, AppUploadView, AppRatingApi, \
    AppRegisterView
from TechKiteERPappstore.scaffolding.views import AppScaffoldingView, \
...
urlpatterns = [
    ...
    url(r'^api/', include('TechKiteERPappstore.api.urls',
                          namespace='api')),
    url(r'^account/',
        include('TechKiteERPappstore.user.urls', namespace='user')),
