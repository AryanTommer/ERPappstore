...
from TechKiteERPappstore.core.models import App, Category, Screenshot
        ...
        try:
            ...
            if user.is_superuser:
                ...
                send_mail("New integration submitted", "Please review the "
                                                       ...
                                                       "sure it fits the "
                                                       "guidelines.",
                          settings.TechKiteERP_FROM_EMAIL,
                          settings.TechKiteERP_INTEGRATIONS_APPROVAL_EMAILS)
            p.save()
            if self.data['screenshot']:
                screenshot = Screenshot.objects.create(
                    url=self.cleaned_data['screenshot'],
