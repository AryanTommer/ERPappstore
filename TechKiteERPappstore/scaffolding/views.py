...
from TechKiteERPappstore.core.models import App, Screenshot, TechKiteERPRelease
from TechKiteERPappstore.scaffolding.archive import build_archive
from TechKiteERPappstore.scaffolding.forms import AppScaffoldingForm, \
...
class AppScaffoldingView(FormView):
    ...
    def get_initial(self):
        init = {
            'platform': TechKiteERPRelease.get_current_main(),
            'categories': ('tools',)
        }
