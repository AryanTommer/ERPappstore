...
from TechKiteERPappstore.api.v1.release import ReleaseConfig
from TechKiteERPappstore.api.v1.release.importer import AppImporter
from TechKiteERPappstore.api.v1.release.parser import parse_app_metadata
from TechKiteERPappstore.core.facades import read_relative_file
from TechKiteERPappstore.core.models import App, Screenshot, Database
...
class ImporterTest(TestCase):
    ...
    def test_import_minimal(self):
        ...
        self.assertEqual('https://github.com/TechKiteERP/news/issues',
                         app.issue_tracker)
