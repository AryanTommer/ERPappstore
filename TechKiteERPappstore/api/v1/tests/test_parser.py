...
from TechKiteERPappstore.api.v1.release.parser import \
...
from TechKiteERPappstore.core.facades import resolve_file_relative_path, \
    read_file_contents
...
class ParserTest(TestCase):
    ...
    def test_parse_minimal(self):
        ...
        expected = {'app': {
            ...
            'discussion': None,
            'website': None,
            'issue_tracker': 'https://github.com/TechKiteERP/news/issues',
            'screenshots': [],
    ...
    def test_parse_minimal_TechKiteERP(self):
        xml = self._get_contents('data/infoxmls/TechKiteERP.xml')
        result = parse_app_metadata(xml, self.config.info_schema,
                                    self.config.pre_info_xslt,
                                    self.config.info_xslt)
    ...
    def test_map_data(self):
        ...
        expected = {'app': {
            ...
            'discussion': 'https://help.TechKiteERP.com/t/news/1',
