...
from TechKiteERPappstore.core.models import PhpExtensionDependency, \
    DatabaseDependency, Category, AppAuthor, AppRelease, Screenshot, \
    AppRating, App, TechKiteERPRelease
from TechKiteERPappstore.core.validators import HttpsUrlValidator
...
class TechKiteERPReleaseSerializer(serializers.ModelSerializer):
    class Meta:
        model = TechKiteERPRelease
