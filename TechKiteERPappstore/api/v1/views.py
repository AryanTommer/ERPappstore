...
from TechKiteERPappstore.api.v1.release.importer import AppImporter
from TechKiteERPappstore.api.v1.release.provider import AppReleaseProvider
from TechKiteERPappstore.api.v1.serializers import AppSerializer, \
    AppReleaseDownloadSerializer, CategorySerializer, AppRatingSerializer, \
    AppRegisterSerializer, TechKiteERPReleaseSerializer
from TechKiteERPappstore.certificate.validator import CertificateValidator
from TechKiteERPappstore.core.facades import read_file_contents
from TechKiteERPappstore.core.models import App, AppRelease, Category, \
    AppRating, TechKiteERPRelease
from TechKiteERPappstore.core.permissions import UpdateDeletePermission
from TechKiteERPappstore.core.throttling import PostThrottle
from TechKiteERPappstore.core.versioning import version_in_spec
from TechKiteERPappstore.user.facades import update_token
...
class TechKiteERPReleaseView(ListAPIView):
    queryset = TechKiteERPRelease.objects.all()
    serializer_class = TechKiteERPReleaseSerializer
...
class AppView(DestroyAPIView):
    ...
    def _filter_releases(self, data, version):
        ...
        :param version: the TechKiteERP version that we filter
...
class AppRegisterView(APIView):
    ...
    def post(self, request):
        ...
        chain = read_file_contents(settings.TechKiteERP_CERTIFICATE_LOCATION)
        crl = read_file_contents(settings.TechKiteERP_CRL_LOCATION)
