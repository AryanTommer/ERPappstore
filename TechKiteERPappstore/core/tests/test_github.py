...
from TechKiteERPappstore.core.facades import read_relative_file
from TechKiteERPappstore.core.github import GitHubClient, \
    get_supported_releases, sync_releases
from TechKiteERPappstore.core.models import TechKiteERPRelease
...
class GitHubTest(TestCase):
    ...
    def test_import_releases(self):
        ...
        self.assertEquals(16, TechKiteERPRelease.objects.count())
    ...
    def get_rel(self, version: str) -> TechKiteERPRelease:
        return TechKiteERPRelease.objects.get(version=version)

    def _create_release(self, version: str, is_current: bool,
                        has_release: bool,
                        is_supported: bool) -> TechKiteERPRelease:
        return TechKiteERPRelease.objects.create(version=version,
