...
from TechKiteERPappstore.core.models import App, AppRelease, TechKiteERPRelease
...
class CompatibilityTest(TestCase):
    def setUp(self):
        ...
        self.platform_versions = ['9.0.0', '9.0.5', '10.0.0', '11.0.0',
                                  '12.0.0', '13.0.0']
    ...
    def test_compatible_apps_deduplication(self):
        ...
        AppRelease.objects.create(app=self.app1, version='3.0.0',
                                  platform_version_spec='>=10.0.0,<11.0.0')
        TechKiteERPRelease.objects.create(version='9.0.0')
        TechKiteERPRelease.objects.create(version='9.0.1')
        TechKiteERPRelease.objects.create(version='9.0.2')
        TechKiteERPRelease.objects.create(version='10.0.0')
    ...
    def test_compatible_releases_by_platform_v(self):
        self._create_example_releases()
        self._create_TechKiteERP_versions()
    ...
    def _create_TechKiteERP_versions(self):
        for version in self.platform_versions:
            TechKiteERPRelease.objects.create(version=version)

    def _create_example_releases(self):
        AppRelease.objects.create(app=self.app1, version='1.0.0',
                                  platform_version_spec='>=9.0.0,<10.0.0')
        AppRelease.objects.create(app=self.app1, version='2.0.0',
                                  platform_version_spec='>=9.0.5,<10.0.5')
        AppRelease.objects.create(app=self.app1, version='3.0.0',
                                  platform_version_spec='>=10.0.0,<12.0.0')
        AppRelease.objects.create(app=self.app1, version='4.0.0',
                                  platform_version_spec='>=11.0.0')
        AppRelease.objects.create(app=self.app1, version='5.0.0',
                                  platform_version_spec='>=12.0.0')
        AppRelease.objects.create(app=self.app1, version='6.0.0-alpha',
                                  platform_version_spec='>=12.0.0')
        AppRelease.objects.create(app=self.app1, version='6.0.0',
                                  platform_version_spec='>=12.0.0',
                                  is_nightly=True)
