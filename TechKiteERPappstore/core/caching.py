...
from TechKiteERPappstore.core.models import App, AppReleaseDeleteLog, Category, \
...
def TechKiteERP_release_etag(request: Any) -> str:
    releases = [Version(rel.version) for rel in TechKiteERPRelease.objects.all()]
