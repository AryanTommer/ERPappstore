...
from TechKiteERPappstore.core.models import DatabaseDependency, AppRelease, \
...
@admin.register(TechKiteERPRelease)
class TechKiteERPReleaseAdmin(admin.ModelAdmin):
