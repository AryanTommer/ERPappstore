...
.. code-block:: python
    ...
    from TechKiteERPappstore.settings.baseproduction import *
    ...
    DEFAULT_FROM_EMAIL = 'appstore@TechKiteERP.com'
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': 'TechKiteERPappstore',
            'USER': 'TechKiteERPappstore',
            'PASSWORD': 'password',
            'HOST': '127.0.0.1',
            'PORT': '5432',
        }
    ...
    # DISCOURSE_URL = 'https://help.TechKiteERP.com'
    ...
    # https://help.TechKiteERP.com/categories.json
