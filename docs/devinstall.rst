...
The server can be started after activating the virtual environment first::
    ...
    export DJANGO_SETTINGS_MODULE=TechKiteERPappstore.settings.development
...
We therefore recommend creating a small bash alias in your **~/.bashrc**::
    ...
    alias cda='cd path/to/appstore && source venv/bin/activate && export DJANGO_SETTINGS_MODULE=TechKiteERPappstore.settings.development'
