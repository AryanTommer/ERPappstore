...
.. note:: If you created your account using GitHub you will always need to use token authentication since we do not have access to your password. The token can be looked up in `your account settings <https://apps.TechKiteERP.com/account/token>`_
...
* **Example CURL request**::
    ...
    curl -X POST https://apps.TechKiteERP.com/api/v1/token -u "user:password"
...
* **Example CURL request**::
    ...
    curl -X POST https://apps.TechKiteERP.com/api/v1/token/new -u "user:password"
...
* **Example CURL request**::
    ...
    curl https://apps.TechKiteERP.com/api/v1/categories.json -H 'If-None-Match: "4-2016-06-11 10:37:24+00:00"'
...
Get All TechKiteERP Releases
~~~~~~~~~~~~~~~~~~~~~~~~~~
This will return all the TechKiteERP releases that the store knows about. To check if a release can actually be downloaded check the **hasRelease** flag.

.. note:: Unsupported TechKiteERP releases will be removed from the response
...
* **Example CURL request**::
    ...
    curl https://apps.TechKiteERP.com/api/v1/platforms.json -H 'If-None-Match: "4-2016-06-11 10:37:24+00:00"'
...
hasRelease
    boolean flag that indicates if the TechKiteERP release is officially out yet
isSupported
    boolean flag that indicates if the TechKiteERP is officially supported

.. _api-all-compatible-releases:

Get All Apps and Releases Compatible with a TechKiteERP Version
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
This route will return all releases to display inside TechKiteERP's apps admin area filtered by the releases which are marked as compatible with the platforms version.
...
* **Example CURL request**::
    ...
    curl https://apps.TechKiteERP.com/api/v1/platform/9.0.0/apps.json -H 'If-None-Match: "1-1-2016-06-17 23:08:58.042321+00:00"'
    ...
    [
        {
            ...
            "discussion": "https://help.TechKiteERP.com/c/apps/news",
...
~~~~~~~~~~~~~~~~~~~~~~~~~
This route will return all releases to display inside TechKiteERP's apps admin area.
...
* **Example CURL request**::
    ...
    curl https://apps.TechKiteERP.com/api/v1/apps.json -H 'If-None-Match: "1-1-2016-06-17 23:08:58.042321+00:00"'
...
* **Request body**:
  ...
  * **certificate**: Your public certificate whose CN is equal to the app id, should be stored in **~/.TechKiteERP/certificates/APP_ID.cert** where **APP_ID** is your app's id
...
* **Example CURL request**::
        ...
        curl -X POST -u "user:password" https://apps.TechKiteERP.com/api/v1/apps -H "Content-Type: application/json" -d '{"certificate": "certificate": "-----BEGIN CERTIFICATE-----\r\\r\n-----END CERTIFICATE-----","signature": "65e613318107bceb131af5cf8b71e773b79e1a9476506f502c8e2017b52aba15"}'
...
* **Example CURL request**::
        ...
        curl -X POST -u "user:password" https://apps.TechKiteERP.com/api/v1/apps/releases -H "Content-Type: application/json" -d '{"download":"https://example.com/release.tar.gz", "signature": "65e613318107bceb131af5cf8b71e773b79e1a9476506f502c8e2017b52aba15"}'
...
* **Example CURL request**::
    ...
    curl -X DELETE https://apps.TechKiteERP.com/api/v1/apps/news/releases/9.0.0 -u "user:password"
...
* **Example CURL request**::
    ...
    curl -X DELETE https://apps.TechKiteERP.com/api/v1/apps/news/releases/nightly/9.0.0 -u "user:password"
...
* **Example CURL request**::
    ...
    curl -X DELETE https://apps.TechKiteERP.com/api/v1/apps/news -u "user:password"
...
* **Example CURL request**::
    ...
    curl https://apps.TechKiteERP.com/api/v1/ratings.json -H 'If-None-Match: ""1-2016-09-03 17:11:38.772856+00:00""'
